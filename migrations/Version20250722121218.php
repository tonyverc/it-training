 ...
 */
final class Version20250722121218 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE evaluation_jour (id INT AUTO_INCREMENT NOT NULL, stagiaire VARCHAR(255) NOT NULL, formation VARCHAR(255) NOT NULL, satisfaction INT NOT NULL, clarte INT NOT NULL, difficultes LONGTEXT DEFAULT NULL, suggestions LONGTEXT NOT NULL, date DATE NOT NULL, UNIQUE INDEX UNIQ_9751967D4F62F731AA9E377A (stagiaire, date), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
